<div class="w-fit p-4 pb-8  sm:p-8 rounded-2xl mx-auto bg-pars-100 shadow">

    <p class="block text-center font-extrabold my-8">کاربر گرامی، شما می توانید با کلیک بر روی هر یک از مجوزهای زیر از صحت و اصالت آن اطمینان حاصل کنید</p>

    <div class="flex flex-row-reverse w-full p-4 pb-8  sm:p-8 rounded-2xl mx-auto  justify-center">
