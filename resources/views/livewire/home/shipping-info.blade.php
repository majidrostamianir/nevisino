            ...
            <div class="p-6 md:p-8 space-y-8">
                ...
                <div>
                    ...
                    <div class="space-y-3 text-gray-600 pr-4">
                        ...
                        <p>✅ کلیه سفارش‌ها در <strong>کارتن‌های پستیِ سه‌لایه و با کیفیت بالا</strong> بسته‌بندی
                            می‌شوند.</p>
                        <p>✅ فضاهای خالی داخل کارتن با <strong>ضربه‌گیر</strong> پر می‌شود تا از برخورد محصولات با
                            یکدیگر جلوگیری شود.</p>
                        <p>✅ کارتن پستی از چند جهت با <strong>چسب مخصوص</strong> محکم می‌شود تا بسته بودن کارتن در طول
                            مسیر ارسال تضمین گردد.</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-3 text-gray-600 pr-4">
                        <p>⏰ سفارش‌هایی که تا ساعت <strong>{{ english_to_persian_num('۱۰ صبح') }}</strong> روزهای کاری
                            ثبت شوند، همان روز ارسال می‌گردند.</p>
                ...
                <div class="bg-gray-50 rounded-xl p-5">
                    ...
                    <div class="space-y-3 text-sm">
                        <div>
                            ...
                            <p class="text-gray-500">بله، بعد از ثبت سفارش، در پیش‌خوان و بخش سفارش‌ها می‌توانید با
                                استفاده از دکمه رهگیری موقعیت دقیق مرسوله خود را مشاهده کنید.</p>
                        </div>
                        <div>
                            <p class="font-semibold text-gray-800">❓ هزینه ارسال چقدر است؟</p>
                            <p class="text-gray-500">در روش پس‌کرایه هزینه ارسال بر اساس وزن و مقصد محاسبه می‌شود و در
                                زمان تحویل مرسوله از شما اخذ می‌گردد. در روش پیش‌کرایه مبلغ ثابتی که در صفحه تکمیل سفارش
                                به شما نمایش داده می‌شود به فاکتور شما افزوده می‌شود و دیگر در هنگام تحویل گرفتن مرسوله
                                هیچ‌گونه وجهی پرداخت نمی‌کنید.</p>
                        </div>
                        <div>
