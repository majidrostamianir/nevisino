...
{{--                            aria-expanded="false">--}}
{{--                        <img src="{{ asset('images/business-card.png') }}" width="35" alt="">--}}
{{--                        <span class="flex-1 ms-3 sm:hidden group-hover:block text-right rtl:text-right whitespace-nowrap">کارت ویزیت</span>--}}
...
{{--                        @foreach(\App\Models\Url::query()->where('category_id',1)->get() as $value )--}}
{{--                            <li>--}}
