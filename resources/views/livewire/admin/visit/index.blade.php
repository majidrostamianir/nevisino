<div>
    <div class="overflow-x-scroll rounded-lg shadow ">
        <table class="min-w-full text-right bg-pars-100">
            ...
            <tr>
                <th class="px-4 py-2 ">
                    <input wire:model.live.debounce.500ms="queryIp" class="rounded-2xl bg-white h-8 px-2" placeholder="جستجوی آیپی ...">
                </th>
                <th class="px-4 py-2 ">
                    <input wire:model.live.debounce.500ms="queryUser" class="rounded-2xl bg-white h-8 px-2" placeholder="جستجوی کاربر ...">
                </th>
                <th class="px-4 py-2 ">صفحه</th>
                <th class="px-4 py-2 ">رفرر</th>
                <th class="px-4 py-2 ">باته؟</th>
